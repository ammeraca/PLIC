...
__decorate([
    (0, typeorm_1.ManyToOne)((type) => parcours_entity_1.Parcours, (parcours) => parcours.group),
    __metadata("design:type", parcours_entity_1.Parcours)
], Group.prototype, "parcours", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)((type) => riddle_entity_1.Riddle, (riddle) => riddle.group),
    __metadata("design:type", riddle_entity_1.Riddle)
], Group.prototype, "riddle", void 0);
Group = __decorate([
    (0, typeorm_1.Entity)()
], Group);
exports.Group = Group;
